...
function createServer(opts, callback) {
  ...
  options = mixin({
    ...
    "domainSufix" : 'localhost',    // domain of the server, will be the sufix of future registered domains
  ...
  function handleHttpRequest(msg, params) {
    ...
    if (!isValidClientRequestHost(msg.headers.host)) {
      ...
      if (registeredDomain === null) {
        ...
        if (typeof handlerId === 'undefined' || handlerId === null || typeof getConnection(handlerId) === 'undefind' || getConnection(handlerId) === null) {
